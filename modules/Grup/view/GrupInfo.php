...
<div class = "row">
  ...
  <div class="col-1">
  <td><a class="btn btn-warning" href="index.php?module=Grup&function=modificar&codi='<?php echo $grup['codi'] ?>'">Modificar</a></td>
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Eliminar grup</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <p>Està vosté segur d'eliminar el grup <?php echo $asignatura['nom']?> de la base de dades? Aquest grup conte Alumnes</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tornar</button>
        <a type="button" href="index.php?module=Grup&function=baixa&codi='<?php echo $grup['codi'] ?>'" class="btn btn-primary">Eliminar</a>
      </div>
    </div>
  </div>
</div>
...
<div class="tab-content" id="myTabContent">
  ...
  <?php
    ...
    foreach ($list as $key => $value) {
      ...
      echo '<td><a class="btn btn-danger" href="index.php?module=Grup&function=remove&NIA='.$value['NIA'].'">X</a></td>';
      echo '</tr>';
    }
  ?>
  </tbody>
